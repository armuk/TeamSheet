...
<li class="active"><b>Messaging</b></li>
...
echo '<table class="table"><thead><tr><td>Name</td><td>'.$name2[$i].'</td></tr></thead><tr><td>Signed</td><td>'.$datetime2[$i].'</td></tr><tr><td>Picture</td><td><img src="http://jamesjguthrie.com/uploader/uploaded_files/'.$image2[$i].'" width="256" height="144"></img></td></tr></table>';
}
}
